...
let figureSymbolStates: [String] = ["run", "roll", "american.football", "archery", "australian.football", "badminton", "baseball", "basketball", "bowling", "boxing", "climbing", "colldown", "core.training", "cricket", "skiing.crosscountry", "cross.training", "curling", "disc.sports", "skiing.downhill", "elliptical", "fencing", "fishing", "flexibility", "strengthtraining.functional", "golf", "hand.cycling", "handball", "hiking", "hockey", "hunting", "indoor.cycle", "kickboxing", "lacrosse", "martial.arts", "mind.and.body", "open.water.swim", "outdoor.cycle", "pickleball", "racquetball", "rolling", "rower", "rugby", "sailing", "skating", "snowbarding", "soccer", "softball", "squash", "surfing", "table.tennis", "tennis", "strengthtraining.traditional", "volleyball", "water.fitness", "waterpolo"]
